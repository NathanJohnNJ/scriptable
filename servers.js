const initialData = {
    servers: [
      {
      url: 'https://nathanjohnthedom.com:8123',
			title: ' Home Assistant  ',
			emoji: '🏡 ',
			online: null,
		},
		{
			url: 'https://nathanjohnthedom.com:8581',
			title: ' HomeBridge',
			emoji: '🏠 ',
			online: null,
		},
	  {
			url: 'http://nathanjohnthedom.com:61208',
			title: ' MacBook Pro',
			emoji: '💻 ',
			online: null
		},
    {
      url: 'http://nathanjohnthedom.com:8000',
      title: ' CameraPi ',
			emoji: ' 📹',
      online: null
    },
    {
      url: 'http://nathanjohnthedom.com:7979',
		  title: ' Motion Detection ',
			emoji: ' 🕺🏼',
      online: null
    },
    {
      url: 'http://nathanjohnthedom.com:5001',
		  title: ' MariaDB ',
			emoji: ' 🦭',
      online: null
    },
		{
      url: 'https://nathanjohnthedom.com:8083',
      title: ' RPi Zero 2W ',
			emoji: ' 📹',
      online: null
    },
		{
      url: 'https://nathanjohnthedom.com:8085',
      title: ' TreePi ',
			emoji: ' 🎄',
      online: null
    },
...
async function createWidget(items) {
    ...
    const title =  headerStack.addText("S  e  r  v  e  r");
